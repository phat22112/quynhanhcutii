...
startButton.addEventListener("click", () => {
    ...
    if (input== ""){
        ...
        questionLanding.innerHTML = "Có cái tên cũng hong biết nhập là sao nhập lại coaiii!"
    }
    else{
        ...
        document.body.innerHTML = "<div class='wrapper'><h2 class='question'>Hello "+input+ " Coá iu Phát honggg :>>>>></h2>"+
...
function yesButtonListener(){
    document.body.innerHTML = "<div class='wrapper'><h2 class='question'>Oki :>>> Phát cũng iu   "+input+" :>>>!</h2>"+
